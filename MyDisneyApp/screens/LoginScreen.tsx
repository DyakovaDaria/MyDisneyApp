...
export default function App() {
  ...
  const handleServerError = (errorCode) => {
    let errmsg = "";
    if (errorCode === "auth/invalid-email") errmsg = "Invalid email";
    else if (errorCode === "auth/invalid-email") errmsg = "Invalid email";
    else if (errorCode === "auth/user-not-found")
      errmsg = "You need to sign in first";
    else if (errorCode === "auth/wrong-password") errmsg = "Wrong password";
    return errmsg;
  };
  const signIn = () => {
  ...
  return (
    <View style={styles.container}>
      <Image
        style={styles.image}
        source={require("../assets/mickey_logo.png")}
      />
